	...
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li><i class="fa fa-home"></i>공지사항 등록</li>
				</ol>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12">
				<div class="panel">
					<form id="noticeform" method="post" action="/notice/write">
						<label for="title">제목</label><br> <input id="title"
							name="title"
						...
						<input type="button" id="saveButton" class="btn btn-lg btn-danger" onclick="javascript:history.back()" value="취소" />
					</form>
				</div>
			</div>
		</div>
