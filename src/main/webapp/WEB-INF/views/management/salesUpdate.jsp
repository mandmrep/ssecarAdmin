	...
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li><i class="fa fa-home"></i>매출수정</li>
				</ol>
			</div>
		</div>
						...
						<div class="panel-body">
							<div class="padd">
								<div class="form quick-post">
									<form class="form-horizontal" action="/management/salesUpdateAction" method="post" onsubmit="return check()">
										<input type="hidden" name="num" value="${sales.num}">
										<div class="form-group">
											<label class="control-label col-lg-2" for="title">지점명</label>
											<div class="col-lg-10">
												<input type="text" class="form-control" value="${sales.storename}" readonly="readonly">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" id="name" name="name" value="${sales.name}" readonly="readonly">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-2">
												<input type="text" class="form-control" id="cash" name="cash" value="${sales.cash}" pattern='^[0-9]*$' maxlength="20">
											</div>
											<label class="control-label col-lg-2">카드</label>
											<div class="col-lg-2">
												<input type="text" class="form-control" id="card" name="card" value="${sales.card}" pattern='^[0-9]*$' maxlength="20">
											</div>
											<%-- <label class="control-label col-lg-2">기타</label>
											<div class="col-lg-2">
												<input type="text" class="form-control" id="etc" name="etc" value="${sales.etc}" pattern='^[0-9]*$' maxlength="20">
											</div> --%>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-2">
												<input type="text" class="form-control" id="online" name="online" value="${sales.online}" pattern='^[0-9]*$' maxlength="20">
											</div>
											<label class="control-label col-lg-2">소셜</label>
											<div class="col-lg-2">
												<input type="text" class="form-control" id="social" name="social" value="${sales.social}" pattern='^[0-9]*$' maxlength="20">
											</div>
											<label class="control-label col-lg-2">쿠폰</label>
											<div class="col-lg-2">
												<input type="text" class="form-control" id="coupon" name="coupon" value="${sales.coupon}" pattern='^[0-9]*$' maxlength="20">
											</div>
										</div>
										
										<div class="form-group">
											<label class="control-label col-lg-2">쿠폰번호</label>
											<div class="col-lg-10">
												<input type="text" class="form-control" id="couponNo" name="couponNo" value="${sales.couponNo}" maxlength="30">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" id="memo" name="memo" value="${sales.memo}" maxlength="1000">
											</div>
										</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form id="customerForm" class="form-horizontal">
      	...
      	<div class="form-group">
			<div class="col-lg-4">
				<select id="menu_1" class="form-control">
		      		<option value="">선택하세요</option>
			...
			<div class="col-lg-2">
				<button type="button" onclick="getCustomer()" class="btn btn-default">등록</button>
			</div>
		</div>
		
		<div class="checkbox">
			<label><input type="checkbox" onclick="newcustomer()">신규고객</label>
		</div>
		...
		$.ajax({
			...
			success:function(data){
				for(var i = 0;i<data.length;i++){
					html += '<tr>'+
						   '<td onclick="getname(this)">'+data[i].name+'</td>'+
						   '<td>'+data[i].tel+'</td>'+
						   '<td>'+data[i].car+'</td>'+
