	...
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li><i class="fa fa-home"></i>매출관리(제품)</li>
				</ol>
			</div>
		</div>
					...
					<div class="panel-body">
						...
						<table id="salesTable" class="table table-striped table-advance table-hover">
							<tbody>
								...
								<c:forEach var="sale" items="${products}">
									<tr>
										<td>${sale.num}</td>
										<td>${sale.name}</td>
										<td>${sale.date}</td>
										...
										<td>
											<div class="btn-group">
												...
												<a class="btn btn-danger" href="javascript:del(${sale.num},'products');"><i class="icon_close_alt2"></i></a>
											</div>
										</td>
									</tr>
								</c:forEach>
...
function pagination(idx) {
	var $form = $('<form></form>');
	$form.attr('action', '/management/products');
