	...
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li><i class="fa fa-home"></i>나노 쿼츠 수정</li>
				</ol>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="/nano/update">
							<input type="hidden" name="no" value="${nano.num}">
							<div class="form-group">
								<label class="col-sm-2 control-label">시리얼넘버</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="serialnumber"
										value="${nano.serialnumber}" maxlength="10"
										readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="store"
										value="${nano.store}" maxlength="20" readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="customer"
										value="${nano.customer}" maxlength="10" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="tel" value="${nano.tel}" pattern='[0-9]{9,11}' placeholder="하이픈 없이 숫자만 입력해 주세요." required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden" id="manufacturer" name="manufacturer">
										...
										<input type="text" id="car" name="car" class="form-control" readonly="readonly" value="${nano.car}" data-toggle="modal" data-target="#myModal">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="number"
										value="${nano.number}" maxlength="13" required>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="col-lg-offset-2 col-lg-9">
									...
									<button type="submit" class="btn btn-danger" onclick="javascript:history.back()">취소</button>
								</div>
							</div>
