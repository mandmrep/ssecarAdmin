	...
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				...
				<ol class="breadcrumb">
					<li><i class="fa fa-home"></i>보도자료 등록</li>
				</ol>
			</div>
		</div>
		<div class="row">
					...
					<div class="panel-body">
						...
						<form id="newsform" action="/news/regist" method="post" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="title" name="title" placeholder="제목을 입력하세요." maxlength="50" required>
							</div>
							<div class="form-group">
								<label for="title">부제목</label> 
								<input type="text" class="form-control" id="subtitle" name="subtitle" maxlength="100" placeholder="부제목을 입력하세요.">
							</div>
							<div class="form-group">
								<label for="link">내용</label> 
								<textarea id="content" name="content" style="width: 1200px; height: 300px;" placeholder="링크를 넣어주세요." required></textarea>
							</div>
