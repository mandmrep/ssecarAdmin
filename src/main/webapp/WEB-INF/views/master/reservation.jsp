						...
						<div class="panel-body">
							<div class="padd">
								<div class="form quick-post">
									<form class="form-horizontal" action="/master/reservation" method="post">

										<div class="form-group">
											<div class="col-lg-11">
												<input type="text" id="name" name="name" class="form-control" placeholder="지점명을 입력해주세요." required="required"> 
											</div>
											<div class="col-lg-1">
				...
				<section class="panel">
					<div class="panel-body">
						<table id="accountTable" class="table table-striped table-advance table-hover">
							<tbody>
								<tr>
									<th><i class="icon_calendar"></i> 지점명</th>
...
<script>
	function detail(idx,n){
		var $form = $('<form></form>');
		$form.attr('action', '/master/reservationDetail');
	    $form.attr('method', 'post');
	    $form.appendTo('body');
	    
	    var idx = $('<input type="hidden" name="fno" value="'+idx+'">');
	    var fname = $('<input type="hidden" name="fname" value="'+n+'">');
	    $form.append(idx).append(fname);
	    $form.submit();
	}
</script>