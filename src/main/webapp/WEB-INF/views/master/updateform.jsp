						...
						<div class="panel-body">
							<div class="padd">
								<div class="form quick-post">
									<form class="form-horizontal" action="/master/reserveUpdate" method="post" onsubmit="return check()">
										<input type="hidden" id="num" name="num" value="${reserveInfo.num}">
										<input type="hidden" id="fno" name="fno" value="${fno}">
										
										<div class="form-group">
											<label class="control-label col-lg-2" for="title">예약일</label>
											<div class="col-lg-10">
												<input type="text" class="form-control" id="date" name="date" value="${reserveInfo.date}" readonly="readonly">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" id="name" name="name" value="${reserveInfo.name}" required="required" data-toggle="modal" data-target="#customerModal">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" id="tel" name="tel" value="${reserveInfo.tel}" pattern='[0-9]{9,11}' required="required">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="hidden" id="manufacturer" name="manufacturer" value="${reserveInfo.manufacturer}">
												<input type="hidden" id="vehicle" name="vehicle" value="${reserveInfo.vehicle}">
												<input type="text" id="temp" name="temp" value="${reserveInfo.title}" required="required" readonly="readonly" class="form-control" data-toggle="modal" data-target="#myModal">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" id="memo" name="memo" value="${reserveInfo.memo}">
											</div>
										</div>
...
<script>
	...
	$("#start").val("${reserveInfo.start}").attr("selected", "selected");
	$('#service').val("${reserveInfo.service}");
	$('#motivation').val('${reserveInfo.motivation}');
